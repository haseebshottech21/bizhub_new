...
class _MoreScreenState extends State<MoreScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: bottomProvider.token == null || bottomProvider.token == ''
          ? _profileBodyWithoutAuth()
          : _profileBodyWithAuth(),
    );
  }

  Widget _profileBodyWithAuth() {
    final auth = context.watch<AuthViewModel>();
        ...
        children: [
          ViewProfile(
            ...
            image: auth.getPrefrenceValue('image') == null.toString()
                ? EmptyProfile(
                    height: 80,
                    width: phoneDevice ? deviceWidth / 5.5 : deviceWidth / 7.5,
                    iconSize: 55,
                    radius: 100,
                  )
                : CachedImageWidget(
  ...
  Widget _profileBodyWithoutAuth() {
    return SafeArea(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
